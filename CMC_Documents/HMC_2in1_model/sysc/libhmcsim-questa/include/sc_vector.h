...
namespace sc_meta {
  ...
  struct is_same      { BOOST_STATIC_CONSTANT( bool, value = false ); };
  template< typename T >
  struct is_same<T,T> { BOOST_STATIC_CONSTANT( bool, value = true );  };

  template< typename T >
  struct is_const           { BOOST_STATIC_CONSTANT( bool, value = false ); };
  template< typename T >
  struct is_const< const T> { BOOST_STATIC_CONSTANT( bool, value = true );  };
